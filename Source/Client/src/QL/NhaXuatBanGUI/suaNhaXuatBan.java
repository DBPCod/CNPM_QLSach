 ...
 * @author luuis
 */
public class suaNhaXuatBan extends javax.swing.JFrame {

    /**
     * Creates new form xuaNhaXuatBan
     */
    private static panelNhaXuatBan panelNhaXuatBan1;
    private static String MaDT1;
    private static Client client1;
    
    public suaNhaXuatBan(String MaDT, Client client, panelNhaXuatBan panelNhaXuatBan) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new suaNhaXuatBan(MaDT1, client1, panelNhaXuatBan1).setVisible(true);
            }
        });
    }
